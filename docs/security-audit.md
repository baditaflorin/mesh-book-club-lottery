# Security audit — mesh-book-club-lottery

Generated: **2026-08-26T01:06:28.874Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "2e30f2dfa51f9720fc27a3e5ed6369bfefc52fce59550666770f683c529ef6aa",
  "pubkeyB": "2e30f2dfa51f9720fc27a3e5ed6369bfefc52fce59550666770f683c529ef6aa"
}
```
...
```json
{
  "pubkeyA": "90178b11bdb9db98",
  "pubkeyB": "005331f80cc97dfc"
}
```
...
```json
{
  "plantedExpiresAt": 1787706328864,
  "now": 1787706388867
}
```
...
```json
{
  "realPubkey": "3a433b8c18c03d82",
  "forgerPubkey": "391b8d72e13b7183"
}
```
...
```json
{
  "forgedPubkey": "65fa34fb1de58cce",
  "realPubkey": "8df462445b9dfcb3"
}
```
